...
def topology():
    ...
    info("*** Creating nodes\n")
    # sta0 = net.addStation('sta0', position='250,200,0')
    sta1 = net.addStation('sta1', position='250,250,0')
    sta2 = net.addStation('sta2', position='217,250,0')
    sta3 = net.addStation('sta3', position='183,250,0')
    sta4 = net.addStation('sta4', position='150,250,0')
    sta5 = net.addStation('sta5', position='150,200,0')
    # sta6 = net.addStation('sta6', position='150,150,0')
    # sta7 = net.addStation('sta7', position='183,150,0')
    # sta8 = net.addStation('sta8', position='217,150,0')
    # sta9 = net.addStation('sta9', position='250,150,0')
